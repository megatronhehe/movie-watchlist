...
const Menu = () => {
	return (
		<div>
			<section className="text-blue-500 tracking-wide p-4 mx-5 mb-8 bg-gray-100 h-full rounded-lg shadow-lg">
			...
			<section className="text-blue-100 tracking-wide p-4 mx-5 mb-8 bg-blue-500 h-full rounded-lg shadow-lg">
				<div className="border-b-2 text-right">
					<h1 className="text-3xl">Search</h1>
					<p className="my-2 ">a movie or a show</p>
				</div>
			...
			<section className="text-blue-100 tracking-wide p-4 mx-5 mb-8 bg-blue-700 h-full rounded-lg shadow-lg">
				<div className="border-b-2">
